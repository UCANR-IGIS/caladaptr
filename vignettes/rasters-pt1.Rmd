...
```{r slice_filter, paged.print = FALSE}
mercd_stars_lst[[1]] %>% 
  slice(10:12, along = "x") %>% 
  slice(7:10, along = "y") %>% 
...
```{r plot_mercd_stars_lst, fig.show='hold'}
...
```{r one_gcm_scen_lst_c2, paged.print = FALSE}
