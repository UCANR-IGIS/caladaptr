...
To deal with this, we can estimate hourly temperatures based on the daily minimum and maximum temperature, as well as the time of sunrise and sunset. The [**chillR**](https://cran.r-project.org/package=chillR) package, developed and maintained by [Dr. Eike Luedeling](http://eikeluedeling.com/), has functions for modeling hourly temperatures and computing chill portions (see the chillR [Vignette](https://cran.r-project.org/web/packages/chillR/vignettes/hourly_temperatures.html) for details).
...
Want to skip the details? You can [**&ddarr; cut to the chase &ddarr;**](#how-many-growing-seasons-reach-minimum-chill-requirements).
...
## 7) Identify the Date When the Accumulated Chill Portions Reach a Threshhold
...
## 6) How Many Growing Seasons Reach Minimum Chill Requirements
...
## 7) Plot Accumulated Chill Curves

We plot the curves for accumulated chill for RCP 4.5 and 8.5. We have 10 growing seasons and 10 GCMs, for a total of 100 curves. The lines that end above the minimum chill requirement represent simulations where the minimum chill for a viable crop was reached. 
...
## 8) Plot the distribution of ripened dates during successful years
