...
Want to skip the details? You can [**&ddarr; cut to the chase &ddarr;**](#how-many-growing-seasons-reach-the-minimum-chill-requirement).
...
ggplot(pt1_10yrs_maxchill, aes(x=max_chill)) + 
  geom_histogram() +
...
Need to show historical chill curves (actual or modelled?) for reference.
